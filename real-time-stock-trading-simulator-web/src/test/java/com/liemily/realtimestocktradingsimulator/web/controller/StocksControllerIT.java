...
public class StocksControllerIT {
    ...
    public void testGetBuyableShares() throws Exception {
        String stockPage = stocksController.getBuyableStocks(model, new PageRequest(0, stockViewService.getStocksWithVolume(null).size()), null, null, null, null, null);
    ...
    public void testGetSellableShares() {
        ...
        String stockPage = stocksController.getSellableStocks(model, principal, null, null, null, null, null, null);
    ...
    public void testGetOrderedStocks() {
        ...
        stocksController.getBuyableStocks(model, new PageRequest(0, Integer.MAX_VALUE), null, null, null, null, null);
    ...
    public void testEachRowIsCompanyStock() {
        ...
        stocksController.getBuyableStocks(model, null, null, null, null, null, null);
        ...
        model = new ExtendedModelMap();
        stocksController.getSellableStocks(model, principal, null, null, null, null, null, null);
    ...
    public void testViewAllUserStocks() {
        ...
        stocksController.getSellableStocks(model, principal, new PageRequest(0, Integer.MAX_VALUE), null, null, null, null, null);
        Collection<UserStock> retrievedUserStocks = (Collection<UserStock>) model.asMap().get(stocksController.getStocksAttribute());
    ...
    private void testPaginationSize(int expectedSize, Pageable pageable) {
        stocksController.getBuyableStocks(model, pageable, null, null, null, null, null);
        ...
        model = new ExtendedModelMap();
        stocksController.getSellableStocks(model, principal, pageable, null, null, null, null, null);
